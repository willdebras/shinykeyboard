colorlist <- list(
  sharla1 = c(keyboard_color = "#51504A",  modifier_color = "#ffce00", alphanum_color = "#EDEDD8", accent_color = "#454A49", background_colour = "lightgrey", alphanum_stroke = "#99ccf1", modifier_stroke = "#59aae6", accent_stroke = "#85dab1", text_color = "lightgrey"),
