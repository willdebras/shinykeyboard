colorlist <- list(
  sharla1 = c(keyboard_color = "#fbbcb8",  modifier_color = "#78baeb", alphanum_color = "#bfdff6", accent_color = "#a3e3c4", background_colour = "lightgrey", alphanum_stroke = "#99ccf1", modifier_stroke = "#59aae6", accent_stroke = "#85dab1", text_color = "#5F5F5F"),
